...
\makechapter[\myquote]{Chapter 1: Thesis Introduction}{An overview of this work}{The raison d'\^{e}tre.\label{ch1}}
\input{chapter1.tex}

\makechapter{Chapter 2: Methodology Chapter}{Data and method applied to it}{Methods used\\ \label{ch2}}
\input{chapter2.tex}

\makechapter{Literature Review}{A small survey of the literature}{Literature Surveyed\\ \label{ch3}}
\input{chapter3.tex}

\makechapter{Results Chapter}{Results attained}{Results obtained \\ \label{ch4}}
\input{chapter4.tex}

\makechapter{Dicussion Chapter}{The possible meaning of this work}{Discussion of things\\ \label{ch5}}
\input{chapter5.tex}

\makechapter{Conclusions  Chapter}{In closing}{Conclusions made, insights gathered\\ \label{ch6}}
\input{chapter6.tex}
